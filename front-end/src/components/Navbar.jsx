...
const Navbar = () => {
 ...
 setToken('')
  ...
  return (
    ...
    <Link to='/'> <img className='w-36' src={assets.loga} alt="" /></Link>
 ...
 <NavLink to='/contact' className='flex flex-col items-center gap-1'>
   ...
   <hr className='border-none w-2/4 h-[1.5px] bg-gray-700 hidden'/>
      ...
      <div className='flex items-center gap-6'>
        ...
        <p className='absolute right-[-5px] bottom-[-5px] bg-black text-white rounded-full aspect-square text-[8px] text-center leading-4 w-4'>{getCardCount()}</p>
         </Link>
         <img onClick={()=>setVisible(true)} src={assets.menu_icon} className='w-5 min-w-5 sm:hidden' />
      </div>
