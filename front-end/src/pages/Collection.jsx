  ...
  return (
    <div className='flex flex-col gap-1 pt-10 border-t sm:flex-row sm:gap-10'>
      <div className='min-w-60'>
        ...
        <div className='flex flx-row items-center gap-4 ' >
        <p onClick={() => setShowFilter(!showFilter)} className='flex items-center my-2 text-xl gap-2 cursor-pointer '>FILTERS</p>
        ...
        <div className='flex flex-col text-base text-gray-700 font-light gap-2'>
